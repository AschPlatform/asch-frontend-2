  ...
  <q-page>
    ...
    <q-card class="row padding-20 margin-top-20" color="white" text-color="black" v-if="$q.platform.is.mobile">
      ...
      <div class="row col-12">
        <q-field :label-width="2" :label="$t('proposal.SELECT_P_TITLE')" class="col-12 font-16">
          <q-input readonly hide-underline v-model="detail.title" value=""/>
        </q-field>
        </div>
        <div class="row col-12">
          <q-field :label-width="2" :label="$t('proposal.SELECT_P_TYPE')" class="col-6 font-16">
            <q-input readonly hide-underline v-model="dealWithType" value=""/>
            <!-- <span>{{detail.content | jparse('name', false)}}</span> -->
          </q-field>
        </div>
        <div class="row col-12">
            <q-field :label-width="4" class="col-12 font-16" :label="$t('proposal.SELECT_P_PERIOD')">
            </q-field>
            <div class="col-12">
              <span class="font-16">{{time_buffer}}</span>
              <span class="self-center col-2 font-16" align="center">{{$t('TO')}}</span>
               <span class="font-16">{{time_end}}</span>
            </div>
    ...
    <q-card class="row padding-20 margin-top-20" color="white" text-color="black"  v-if="$q.platform.is.mobile">
      ...
      <q-card-main class="col-12">
          ...
          <div class="col-12" v-if="this.detail.topic === 'gateway_register'" id="new">
            ...
            <div class="row col-12">
              <q-field class="block col-12 font-16" label-width="10" :error-label="$t('ERR.ERR_3_15')" :label="$t('LAUNCH_MODAL.MEMBER_NUMBER')">
                <q-input readonly hide-underline v-model="content.minimumMembers" value=""></q-input>
              </q-field>
            </div>
            <div class="row col-12">
              <q-field class="col-12 font-16" label-width="4" :error-label="$t('ERR.ERR_1_30')" :label="$t('LAUNCH_MODAL.PERIOD_NET')">
                <q-input disabled readonly hide-underline v-model="content.interval" value="" color="black">{{$t('LAUNCH_MODAL.DAY')}}</q-input>
              </q-field>
            </div>
            <div class="row col-12">
              <q-field class="col-12 font-16" label-width="2" :error-label="$t('ERR.ERR_50_1000')" :label="$t('LAUNCH_MODAL.BRIEF')">
                <q-input class="col-12" type="textarea" value="" readonly hide-underline v-model="detail.desc"></q-input>
              </q-field>
            </div>
          </div>
          ...
          <div class="col-12" v-if="this.detail.topic === 'gateway_init'" id="init">
            <div class="row col-12">
              <q-field class="col-12 font-16" label-width="2" :label="$t('LAUNCH_MODAL.NET_NAME')">
                <q-input readonly hide-underline value="" v-model="content.gateway"></q-input>
              </q-field>
            </div>
            <div class="row col-12">
              <q-field class="col-12 font-16" label-width="2" :label="$t('LAUNCH_MODAL.PROPOSE')">
                <q-input readonly hide-underline value="" v-model="memberString" type="textarea" disabled></q-input>
                <span>{{$t('LAUNCH_MODAL.PROPOSE_END')}}</span>
              </q-field>
            </div>
          </div>
