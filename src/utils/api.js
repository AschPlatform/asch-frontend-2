...
const translateErrMsg = (language, input) => {
    ...
    var translateMap = [
      {
        ...
        chinese: this.Translations[language].ERR_TOAST_SECONDKEY_WRONG
      },
      {
      ...
      { error: 'Asset not exists', chinese: this.Translations[language].ERR_TOAST_ASSET_NOTEXIST },
      {
        ...
        chinese: this.Translations[language].ERR_TOAST_ASSET_INSUFFICIENT
      },
      {
        error: 'Voting limit exceeded. Maximum is 33 votes per transaction',
        chinese: this.Translations[language].ERR_TOAST_VOTE_LIMIT
      },
      {
        error: 'Account is locked',
        chinese: this.Translations[language].ERR_TOAST_ACCOUNT_ALREADY_LOCKED
      },
      {
        error: 'Invalid recipient',
        chinese: this.Translations[language].ERR_TOAST_ACCOUNT_INVALID_RECIPIENT
      },
      {
        error: 'timestamp',
        chinese: this.Translations[language].ERR_TOAST_ACCOUNT_INVALID_TIMESTAMP
      }
    ]
