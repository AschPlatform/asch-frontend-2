  ...
  <div class="tab-panel-container row ">
    <q-transition appear enter="fadeIn" leave="fadeOut" mode="out-in">
      <div v-if="balancesData" class="col-12 shadow-1">
        <q-data-table :data="balancesData.balances" :config="tableConf" :columns="columns" @refresh="refresh" @rowclick="rowClick">
...
export default {
  ...
  methods: {
    ...
    getAssetRule(cell) {
      return `${cell.allowWriteoff === 0 ? 'Y' : 'N'}/${
        cell.allowWhitelist === 0 ? 'Y' : 'N'
