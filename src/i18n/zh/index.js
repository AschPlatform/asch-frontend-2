const lang = {
  ...
  DELETE_VOTE_TIP: '每次可最多同时删除对 1 人的投票',

  // model - vote
  VOTE_TITLE: '投票给受托人',
  VOTE_TIP: '请确认您的选择与投票，每张票最多可以同时投 1 人',
  ...
  ERR_DELETE_NO_MORE_THAN_1: '一次删除至多 1 位候选人',
  ERR_VOTE_NO_MORE_THAN_1: '一次投票至多 1 位候选人',
  ...
  OPERATION_REQUIRES_NET_OR_FEE: '该操作需要消耗 {net} NET 或 {fee} XAS',
  REQUIRES_FEE: '需要消耗 {net} Net 或 {fee} XAS',
  ...
  USER_AGREEMENT_MODAL_TIPS: '*注册成为代理人将消耗 1000000 NET 或 100 XAS',
  ...
  LOCK_DETAIL_TIP: '请设置锁仓额度，该行为将消耗 1000 NET 或 0.1XAS',
  RETREAT_VOTE_SUCCESS: '撤销投票成功',
  DELEGATE_LIST_DETAILS: '受托人详情列表',
  SECOND_PASSWORD_TIP: '请设置8位数以上的密码，需花费 50000 NET 或 5 XAS',
  ...
  VOTE_CANCEL: '撤销代理人',
  VOTE_SET: '设置代理人',
  VOTE_DELEGATE_TIP: '请输入代理人昵称，这会消耗 1000NET 或 0.1 XAS',
  ALL_BLOCKS: '全部区块',
  ...
  CHAR_NUM: '字符数',
  NAME_TIP: '可以消耗NET抵扣所需费用，抵扣比例：1XAS = 10000NET',
  PRICE: '价格',
  ...
  AGENT_INFO: '代理人身份:',
  IS_AGENT: '您已经是受托人',
  REGISTER_AGENT: '注册成为受托人',
  EDIT: '修改',
  UNLOCK: '解锁',
  NUM: '额度',
  UNLOCK_TIME_TIPS: '到达高度(时间)后，可以手动解锁额度',
  UNLOCK_TIPS: '锁仓后，该部分额度将无法用于投票/转账在内的日常消耗，请根据实际情况预留出投票/转账等需要用到的额度，您选定的锁仓时间会实际转换为区块高度记录在链上，区块链网络运行过程中可能会出现网络异常的情况将会根据您设定的区块高度重新推算解锁时间（误差一般不会超过24小时），请知晓。',
  SET_UNLOCK_TIME: '选择时间',
  HEIGHT_NOT_ARRIVE: '未到解锁时间',
  NO_ISSUER_INFO: '您还不是发行商',
  COST_FEE: '将消耗 {net} NET 或 {num} XAS',
  ...
  LAUNCH_MODAL: {
    ...
    READ_TIP2: '发布提案将消耗 100000 NET 或 10 XAS',
    INSTEAD_PRE: '变更前',
    INSTEAD_POST: '变更后',
  ...
  TIP_BAR_NORMAL: '当前网关的储备金率为{rate}%，继续充值跨链资产将会继续降低储备金率，为了您的资金安全，请谨慎选择！',
  ...
  ASSET_CATEGORY: '资产类型',
  TIP: '提示:',
  ALERT_TIP: '当前网关的储备金率为{rate}%，继续充值跨链资产将会继续降低储备金率，为了您的资金安全，请谨慎选择！',
  ...
  EXPEND_GAS_LIMIT: '* 可不填写，默认为 {gas}（以合约初始化消耗 5000 Gas估算）具体以实际消耗为准',
  BUY_BACK_POOL_CONTENT: '##### 1.什么是回购池？ \n A：回购池一个由理事会创建的，用于临时存放平台日常运营中产生的Gas收益的特殊账户。\n ##### 2.哪些费用会归入回购池？ \n A：1.5版本上线以后，包括但不限于以下类型的收益会归入回购池：\n a). 平台中使用BCH作为Gas燃料费进行的转账操作产生的系统收益；\n b). 智能合约平台注册/调用/转账 等产生的系统消耗； \n ##### 3.谁可以执行回购池的回购操作？ \n A:  任何用户均可以通过调用特定的合约，发起并自动执行将回购池资金通过BANCOR交易对回购xas的操作；（回购合约每次调用间隔不得少于60480区块）。',
  BURN_POOL_CONTENT: '##### 1.什么是燃烧池？ \n A：燃烧池是一个不受任何用户监管的，用户存放平台回购燃烧掉的XAS的特殊账户地址。\n ##### 2.燃烧池的资金从哪里来？ \n A：燃烧池的资金是由用户通过调用特定合约，将回购池的资金通过BANCOR兑换成xas后转入的。',
  ABOUT_GATEWAY_RETURN_CONTENT: '##### 什么是储备金率？ \n A：储备金率是指网关托管的跨链资产与网关成员缴纳的保证金的比率。\n ##### 储备金率对普通用户的影响？ \n 当储备金率低于120%时，表明跨链网关托管的资产已经超过其成员提交的储备金总额，为避免给用户资产带来不必要的用户每次进行跨链资产充值的时候，系统会进行风险提示，并会通知网关成员即时追加储备金；\n 当网关跨链资产储备金率达到<100%的时候，网关会暂停资产充值功能，直到通过“提现”或“成员追加储备金”的方式使储备金率回到120%以上，即再恢复充值功能。 \n ##### 如何保证用户资金安全？ \n A：当出现不可控的情况导致用户资产受损时，系统会通过提案系统发起“冻结网关资产”提案，投票通过后，会将储备金按照持有比例向用户进行理赔。',
